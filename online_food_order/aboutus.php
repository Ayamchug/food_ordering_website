...
<body>
  ...
  <div class="wide">
    ...
    <h3 style="color: red">About the food culture in Le'</h3>
    <br>
    <h3 style="color: white">Order food & beverages online from restaurants near & around you. <h3 style="color: white">
      ...
      <h3 style="color : white"> We place no minimum order restrictions! Order in as little (or as much) as you'd like.
